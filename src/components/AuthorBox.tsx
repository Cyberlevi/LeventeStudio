export default function AuthorBox() {
  return (
    <div className="my-12 border-y border-white/10 py-8 sm:py-10">
      <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
        <div className="flex-shrink-0">
          <div className="relative">
            <img
              ...
              className="h-24 w-24 rounded-full border border-white/10 object-cover grayscale"
              loading="lazy"
              decoding="async"
              width="96"
              height="96"
        ...
        <div className="flex-1">
          <div className="mb-2 text-[10px] uppercase tracking-[0.18em] text-white/50">Szerző · weboldalkészítő</div>
          ...
          <div className="flex flex-wrap items-center gap-5 text-sm">
            <a href="/rolam/" className="border-b-2 border-signal-500 pb-1 font-medium text-white hover:border-white">Bővebben rólam</a>
            <a href="https://github.com/Cyberlevi" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white">GitHub</a>
          </div>
        </div>
      </div>
    </div>
