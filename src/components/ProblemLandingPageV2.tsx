        ...
        <div className="subpage-container relative z-10">
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-10 lg:gap-16 items-end">
            ...
            <aside className="tech-status-panel">
              ...
              <div className="space-y-3">{['Probléma','Ok','Prioritás','Lépés'].map((item,index) => <div key={item} className="flex items-center justify-between gap-5 py-2 border-b border-white/[0.06] last:border-0"><span className="text-sm text-white/40">{String(index+1).padStart(2,'0')}</span><span className="text-sm text-white">{item}</span></div>)}</div>
