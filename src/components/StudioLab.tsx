          ...
          {referenceProjects.map((project) => {
            ...
            return (
              <article key={project.id} className="overflow-hidden rounded-xl border border-graphite-950/10 bg-white">
                <a href={primaryUrl} className="group block overflow-hidden border-b border-graphite-950/10" aria-label={`${project.name} projektbemutatás`}>
                ...
                <div className="flex flex-col p-6 sm:p-8">
                  ...
                  <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-3 border-t border-graphite-950/10 pt-5 text-sm">
                    <a href={primaryUrl} className="inline-flex items-center gap-2 font-medium hover:underline">Projekt bemutatása <ArrowUpRight size={15} aria-hidden="true" /></a>
