      ...
      <div className="relative mx-auto max-w-[86rem]">
        <div className="grid gap-12 lg:grid-cols-[.95fr_1.05fr] lg:items-center lg:gap-14">
          ...
          <div className="min-w-0">
            <a href="https://klimatisztak.hu/" target="_blank" rel="noopener noreferrer" className="group block overflow-hidden rounded-xl border border-white/15 bg-ivory-100 shadow-2xl shadow-black/40" aria-label="KlímaTiszták élő weboldal megnyitása új lapon">
            ...
            <div className="mt-5 flex items-center justify-between gap-4 text-xs text-ivory-400"><span>KlímaTiszták · saját projekt · éles weboldal</span><a href="#lab" className="inline-flex items-center gap-2 text-signal-300 hover:underline">Mind a négy munka <ArrowDown size={14} aria-hidden="true" /></a></div>
          </div>
        </div>
